...
const Register = () => {
  // const {users, saveUserDataHandler } = useContext(ProductContext);
  ...
  //   passwordRef.current.type = showPass ? 'text' : 'password';
  // }
  ...
  //   setUsernameUser(e.target.value);
  // };
